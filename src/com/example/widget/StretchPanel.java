...
import com.example.stretchpaneldemo.R;
...
/**
 * Copyright 2013 soso_fy（flytopc@hotmail.com）
 *
...
public class StretchPanel extends LinearLayout {
    ...
    public interface OnStretchListener {
         ...
         * <p>与{@linkplain com.example.widget.isStretchViewOpened isStretchViewOpened()}的返回值是一致的
         */
     ...
     * @param openStatus
     */
    public void setStretchViewOpened(boolean openStatus){
    	isOpened = openStatus;
    	 LayoutParams params = (LayoutParams) mStretchView.getLayoutParams();
         params.height = openStatus? mStretchHeight : 0;
